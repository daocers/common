...
<div class="container">
    ...
    <div class="row table-responsive">
        <table class="table table-bordered">
            ...
            <tbody>
            <c:forEach items="${pi.data}" var="favourite" varStatus="line">
                <tr>
                    <td><input type="checkbox" objId="${favourite.id}"></td>
					                        <td>${favourite.questionId}</td>
					                        <td>${favourite.userId}</td>
					                    <td>
                        <a href="edit.do?id=${favourite.id}&type=detail" class="opr">详情</a>
                        <a href="edit.do?id=${favourite.id}" class="opr">修改</a>
                        <a href="javascript:del(${favourite.id})" class="opr">删除</a>
                    </td>
                </tr>
            </c:forEach>
