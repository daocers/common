                    ...
                    <div class="project-list">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td class="project-people">
                                    <a href="projects.html"><img alt="image" class="img-circle" src="/assets-h/img/a4.jpg"></a>
                                </td>
                                <td class="project-actions">
                                    <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
                                    <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                            ...
                            <tr>
                                ...
                                <td class="project-people">
                                    <a href="projects.html"><img alt="image" class="img-circle" src="/assets-h/img/a1.jpg"></a>
                                    <a href="projects.html"><img alt="image" class="img-circle" src="/assets-h/img/a2.jpg"></a>
                                    <a href="projects.html"><img alt="image" class="img-circle" src="/assets-h/img/a4.jpg"></a>
                                    <a href="projects.html"><img alt="image" class="img-circle" src="/assets-h/img/a5.jpg"></a>
                                </td>
                                <td class="project-actions">
                                    <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
                                    <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                            ...
                            <tr>
                                ...
                                <td class="project-people">
                                    <a href="projects.html"><img alt="image" class="img-circle" src="/assets-h/img/a7.jpg"></a>
                                    <a href="projects.html"><img alt="image" class="img-circle" src="/assets-h/img/a6.jpg"></a>
                                    <a href="projects.html"><img alt="image" class="img-circle" src="/assets-h/img/a3.jpg"></a>
                                </td>
                                <td class="project-actions">
                                    <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
                                    <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
...
<script src="/assets-h/js/content.min.js?v=1.0.0"></script>
<script>
